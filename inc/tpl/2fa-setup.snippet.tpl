...
<div id="two-factor-info">
    <div id="two-factor-info-deactivated">
        ...
        <p style="margin-top:10px; margin-bottom: 10px;"><code
                style="font-size: 12px !important;">%%SUCURI.SecretManual%%</code></p>
    </div>
...
<div id="sucuriscan-totp-form">
    <form id="sucuriscan-totp-form">
        <input name="sucuriscan_totp_code" type="text" id="sucuriscan-totp-code" maxlength="6" pattern="[0-9]{6}"
            placeholder="123 456" autocomplete="one-time-code"
            style="width:240px;text-align:center; margin-bottom: 10px;" />
        ...
        <button type="button" class="button button-primary" id="sucuriscan-totp-submit">
            Setup
        </button>
    </form>
    <span id="sucuriscan-totp-msg" style="margin-left:8px;"></span>
</div>