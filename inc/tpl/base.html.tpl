    ...
    <script type="text/javascript">
        jQuery(document).ready(function ($) {
            ...
            function removeWafModal() {
                try {
                    var overlay = document.querySelector('.sucuriscan-overlay.sucuriscan-register-site-modal');
                    var modal = document.querySelector('.sucuriscan-modal.sucuriscan-register-site-modal');
            ...
            $(document).on('click', '.sucuriscan-overlay.sucuriscan-register-site-modal, .sucuriscan-register-site-modal .sucuriscan-modal-close', function () {
                setWafDismissCookie();
                removeWafModal();
            });
        });
